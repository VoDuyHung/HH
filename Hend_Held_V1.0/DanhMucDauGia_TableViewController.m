//
//  DanhMucDauGia_TableViewController.m
//  Hend_Held_V1.0
//
...
#import "DanhMucDauGia_TableViewController.h"
#import "CellDetailMember_TableViewCell.h"
#import "DBManager.h"
#import "Danhmuc_.h"
@interface DanhMucDauGia_TableViewController (){
...
@implementation DanhMucDauGia_TableViewController
...
- (void)viewDidLoad {
    ...
    for(NSDictionary * dict in responseArr)
    {
        ...
        //for(NSDictionary * dict1 in responseArrContent)
        //{
        // NSLog(@"%@",threadKey);
        if ([responseArrContent count] > 0) {
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSMutableString *imagesSave;
    imagesSave = [NSMutableString stringWithFormat:@"%@ ",
                  [tmpDict1 objectForKey:images_post]];
    [defaults1 setObject:imagesSave forKey:@"image_Post"];
    [defaults1 synchronize];
    
    
    [self performSegueWithIdentifier:@"chititetdaugia" sender:self];
