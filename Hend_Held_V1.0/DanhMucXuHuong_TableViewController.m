//
//  DanhMucXuHuong_TableViewController.m
//  Hend_Held_V1.0
//
...
#import "DanhMucXuHuong_TableViewController.h"
#import "CellDetailMember_TableViewCell.h"
#import "DBManager.h"

@interface DanhMucXuHuong_TableViewController (){
...
@implementation DanhMucXuHuong_TableViewController
...
- (void)viewDidLoad {
    ...
    @try {
        [UIApplication sharedApplication].networkActivityIndicatorVisible = YES;    //truyen username va hashkey vao trong chuoi json----------------------------------
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [self performSegueWithIdentifier:@"noidungxuhuong" sender:self];
