...
- (id)initWithSource:(UIButton *)sender menuHeight:(CGFloat)height itemName:(NSArray *)nameArray
{
    ...
    if(self) {
        ...
        _menuHeight = height;
        _isMenuExpanded = NO;
        [self setUpItemDataSourceWithNames:nameArray subtitles:nil ];
...
- (id)initWithWithSource:(UIButton *)sender menuHeight:(CGFloat)height itemNames:(NSArray *)nameArray   itemSubtitles:(NSArray *)subtitleArray
{
...
- (id)initWithSource:(UIButton *)sender itemNames:(NSArray *)nameArray itemImagesName:(NSArray *)imageArray itemSubtitles:(NSArray *)subtitleArray
{
    ...
    self = [self initWithWithSource:sender menuHeight:(kSACellHeight*nameArray.count)
                          itemNames:nameArray  itemSubtitles:subtitleArray];
    if (self) {
        //Custom init
...
- (void)setUpItemDataSourceWithNames:(NSArray *)nameArr subtitles:(NSArray *)subtitleArr
{
    int n = nameArr.count;
    int s = subtitleArr .count;
    
    
    int totalCount = MAX(n, s);
